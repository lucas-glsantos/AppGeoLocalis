...
const UserAddPost = lazy(() => import("./pages/dashboard/customer/UserAddPost"));
const UserListPost = lazy(() => import("./pages/dashboard/customer/UserListPost"));
const UserEditPost = lazy(() => import("./pages/dashboard/customer/UserEditPost"));
