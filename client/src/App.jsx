...
const AddPost = lazy(() => import("./pages/dashboard/painel/customer/UserAddPost"));
const ListPost = lazy(() => import("./pages/dashboard/painel/customer/UserListPost"));
const EditPost = lazy(() => import("./pages/dashboard/painel/customer/UserEditPost"));
...
const Metrics = lazy(() => import("./pages/dashboard/painel/Metrics"));
			...
			<Suspense
				fallback={
					<div className="min-h-screen flex flex-col items-center justify-center gap-2 bg-white dark:bg-gray-900 transition-colors duration-300">
						...
						<span className="text-sm font-medium text-gray-500 dark:text-gray-400">Carregando...</span>
					</div>
				}
			>
				<Routes>
