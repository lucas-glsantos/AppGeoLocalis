...
const Footer = () => {
  ...
  const InstagramIcon = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="currenColor" viewBox="0 0 20 20">
  ...
  const social = [
    { icon: InstagramIcon, href: "https://www.instagram.com/lucas.glsantos/", label: "Instagram" },
    { icon: LinkedInIcon, href: "https://www.linkedin.com/in/lucasglsantos/", label: "LinkedIn" },
